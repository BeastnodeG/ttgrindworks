...
func vanilla_398913244_toggle_camera_shake() -> void:
...
func vanilla_398913244__sync_mod_settings() -> void:
...
func vanilla_398913244_create_mod_setting(mod_id: String) -> HBoxContainer:
...
func vanilla_398913244_get_mod_enabled(mod_id: String) -> bool:
	var mod_profile := ModLoaderUserProfile.get_current()
	return mod_profile.mod_list[mod_id].is_active

func vanilla_398913244_toggle_mod(mod_id: String, button: GeneralButton) -> void:
...
func vanilla_398913244_cancel_mod_changes() -> void:
...
func toggle_camera_shake():
	if _ModLoaderHooks.any_mod_hooked:
		_ModLoaderHooks.call_hooks(vanilla_398913244_toggle_camera_shake, [], 4078349233)
	else:
...
func _sync_mod_settings():
	if _ModLoaderHooks.any_mod_hooked:
		_ModLoaderHooks.call_hooks(vanilla_398913244__sync_mod_settings, [], 2725898951)
	else:
		vanilla_398913244__sync_mod_settings()


func create_mod_setting(mod_id: String) -> HBoxContainer:
	if _ModLoaderHooks.any_mod_hooked:
		return _ModLoaderHooks.call_hooks(vanilla_398913244_create_mod_setting, [mod_id], 2904310924)
	else:
		return vanilla_398913244_create_mod_setting(mod_id)


func get_mod_enabled(mod_id: String) -> bool:
	if _ModLoaderHooks.any_mod_hooked:
		return _ModLoaderHooks.call_hooks(vanilla_398913244_get_mod_enabled, [mod_id], 3118080005)
	else:
		return vanilla_398913244_get_mod_enabled(mod_id)


func toggle_mod(mod_id: String, button: GeneralButton):
	if _ModLoaderHooks.any_mod_hooked:
		_ModLoaderHooks.call_hooks(vanilla_398913244_toggle_mod, [mod_id, button], 883216797)
	else:
		vanilla_398913244_toggle_mod(mod_id, button)


func cancel_mod_changes():
	if _ModLoaderHooks.any_mod_hooked:
		_ModLoaderHooks.call_hooks(vanilla_398913244_cancel_mod_changes, [], 2313674073)
	else:
		vanilla_398913244_cancel_mod_changes()
